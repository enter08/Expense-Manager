...
Gem::Specification.new do |s|
  ...
  s.files = [".document", ".gitignore", ".travis.yml", "Gemfile", "LICENSE.txt", "README.markdown", "Rakefile", "gibbon.gemspec", "lib/gibbon.rb", "lib/gibbon/api.rb", "lib/gibbon/api_category.rb", "lib/gibbon/export.rb", "lib/gibbon/gibbon_error.rb", "lib/gibbon/mailchimp_error.rb", "spec/gibbon/gibbon_spec.rb", "spec/spec_helper.rb"]
